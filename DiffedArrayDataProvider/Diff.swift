...
func diff<T: Collection>(_ old: T, _ new: T) -> [Operation] where T.Iterator.Element: Hashable, T.Index == Int {
...
/// - parameter new: The new collection.
/// - returns: A list of `Operation` values, representing the diff.
func orderedDiff<T: Collection>(_ old: T, _ new: T) -> [Operation] where T.Iterator.Element: Hashable, T.Index == Int {
